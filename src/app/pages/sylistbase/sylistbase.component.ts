...
@Component({
  selector: 'app-sylistbase',
  templateUrl: './sylistbase.component.html',
  styleUrls: ['./sylistbase.component.css']
})
export class SylistbaseComponent implements OnInit {
  ...
  loadDataFromServer(query:object){
    ...
    this.http.post(this.commonService.domain + 'install/sylistbase/getList', searchParam).subscribe(data => {
